...
HD_PWD='/home/tyh/Documents/pipeline/pipeline.runs/ddr_clock_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr_clock_gen.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ddr_clock_gen.tcl
