...
HD_PWD='/home/tyh/Documents/pipeline/pipeline.runs/div_gen_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_gen_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source div_gen_0.tcl
