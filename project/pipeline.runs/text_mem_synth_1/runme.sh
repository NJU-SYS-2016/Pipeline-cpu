...
HD_PWD='/home/tyh/Documents/pipeline/pipeline.runs/text_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log text_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source text_mem.tcl
