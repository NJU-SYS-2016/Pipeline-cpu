...
HD_PWD='/home/tyh/Documents/pipeline/pipeline.runs/mig_7series_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_7series_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mig_7series_0.tcl
