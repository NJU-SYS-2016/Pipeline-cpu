...
HD_PWD='/home/tyh/Documents/pipeline/pipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipeline.vdi -applog -m64 -messageDb vivado.pb -mode batch -source pipeline.tcl -notrace
