...
HD_PWD='/home/tyh/Documents/pipeline/pipeline.runs/loader_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loader_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source loader_mem.tcl
