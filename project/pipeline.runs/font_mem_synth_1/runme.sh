...
HD_PWD='/home/tyh/Documents/pipeline/pipeline.runs/font_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log font_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source font_mem.tcl
